export const ict_questions = [
  {
    ...
    intermediate: [
      {
        question:
          "Which programming language is primarily used for adding interactivity to web pages?",
        options: ["HTML", "CSS", "JavaScript", "Python"],
        correct_answer: "JavaScript",
        explanation:
          "JavaScript is the programming language of the web that allows adding interactive elements to websites.",
      },
      {
        ...
        correct_answer: "Makes decisions based on conditions",
        explanation:
          "The 'if' statement evaluates a condition and executes a block of code only if the condition is true.",
      },
      {
        question:
          "Which of these is NOT a relational database management system?",
        options: ["MySQL", "MongoDB", "PostgreSQL", "Oracle"],
        correct_answer: "MongoDB",
        explanation:
          "MongoDB is a NoSQL database, while the others are relational database management systems (RDBMS).",
      },
      {
      ...
      },
      {
        ...
        explanation:
          "A stack follows LIFO - the last element added is the first one to be removed.",
      },
      {
        ...
        correct_answer: "To style and layout webpages",
        explanation:
          "CSS (Cascading Style Sheets) is used to control the presentation and layout of HTML documents.",
      },
      {
        question:
          "Which of these is an example of an interpreted programming language?",
        options: ["C++", "Java", "Python", "C#"],
        correct_answer: "Python",
        explanation:
          "Python is an interpreted language, meaning it executes code line by line without needing compilation.",
      },
      {
        ...
        correct_answer: "<a>",
        explanation:
          "The <a> tag defines a hyperlink in HTML, with the href attribute specifying the link destination.",
      },
      {
        question:
      ...
      },
      {
        ...
        correct_answer: "Repeats code a specific number of times",
        explanation:
          "A 'for' loop repeats a block of code a specific number of times or for each element in a sequence.",
      },
      {
        ...
        explanation:
          "Docker is a containerization platform, while Git, SVN and Mercurial are version control systems.",
      },
      {
        question:
        ...
        correct_answer: "To send a value back from the function",
        explanation:
          "The 'return' statement ends function execution and specifies a value to be returned to the function caller.",
      },
      {
        question: "Which of these is a front-end web development framework?",
        options: ["Django", "Flask", "React", "Node.js"],
        correct_answer: "React",
        explanation:
          "React is a JavaScript library for building user interfaces, while the others are backend frameworks.",
      },
      {
      ...
      },
      {
        ...
        correct_answer: "=",
        explanation:
          "The single equals sign '=' is typically used for assignment, while '==' is used for comparison.",
      },
      {
        question: "What is the purpose of an IDE in programming?",
        options: [
          "To design websites visually",
          "To provide a comprehensive development environment",
          "To manage databases",
          "To test network connections",
        ],
        correct_answer: "To provide a comprehensive development environment",
        explanation:
          "An IDE (Integrated Development Environment) combines tools for writing, testing and debugging code.",
      },
      {
        ...
        explanation:
          "Boolean is a data type that can represent one of two values: true or false.",
      },
      {
        question: "What is the correct way to declare a JavaScript variable?",
        options: ["variable name;", "var name;", "v name;", "declare name;"],
        correct_answer: "var name;",
        explanation:
          "In JavaScript, variables are declared using the 'var', 'let', or 'const' keywords.",
      },
      {
        question: "Which of these is a back-end programming language?",
        options: ["HTML", "CSS", "PHP", "JavaScript"],
        correct_answer: "PHP",
        explanation:
          "PHP is a server-side (back-end) language, while HTML/CSS are front-end and JavaScript can be both.",
      },
      {
        question: "What is the purpose of comments in code?",
        options: [
          "To make the program run faster",
          "To explain code to human readers",
          "To create executable commands",
          "To hide code from the compiler",
        ],
        correct_answer: "To explain code to human readers",
        explanation:
          "Comments are ignored by compilers/interpreters and are used to document code for developers.",
      },
      {
      ...
      {
        question: "What is the purpose of the 'else' clause in programming?",
        options: [
          "To handle errors",
          "To provide alternative code when 'if' is false",
          "To repeat code",
          "To define a function",
        ],
        correct_answer: "To provide alternative code when 'if' is false",
        explanation:
          "The 'else' clause executes its block of code when the preceding 'if' condition evaluates to false.",
      },
      {
        ...
        explanation:
          "Django is a Python web framework, while Angular, React and Vue are JavaScript frameworks.",
      },
      {
        ...
        explanation:
          "The DOM (Document Object Model) is a programming interface for web documents that represents the page structure.",
      },
      {
        question:
        ...
        correct_answer: "//",
        explanation:
          "Double forward slash '//' is used for single-line comments in languages like JavaScript, Java, and C++.",
      },
      {
        question:
        ...
        explanation:
          "The 'try-catch' block allows programs to handle exceptions (errors) without crashing.",
      },
      {
        ...
        correct_answer: "MongoDB",
        explanation:
          "MongoDB is a document-oriented NoSQL database, while the others are relational databases.",
      },
      {
        ...
        explanation:
          "In JavaScript, arrays are declared using square brackets [] with elements separated by commas.",
      },
      {
        ...
        correct_answer: "GET",
        explanation:
          "The GET method requests data from a specified resource in RESTful APIs.",
      },
      {
